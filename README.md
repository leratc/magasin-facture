...
To build the final jar and optimize the magasinFacture application for production, run:
...
Then navigate to [http://localhost:9292](http://localhost:9292) in your browser.

...
export class FactureComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.factureService
      ...
      .subscribe(
        (res: HttpResponse<IFacture[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFactures(): void {
    this.eventSubscriber = this.eventManager.subscribe('factureListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFacture[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {

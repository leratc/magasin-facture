...
export class LigneCommandeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.ligneCommandeService
      ...
      .subscribe(
        (res: HttpResponse<ILigneCommande[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ILigneCommande[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
